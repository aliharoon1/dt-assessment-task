...
use function DTApi\Repository\array_only;
use function DTApi\Repository\collect;
use function DTApi\Repository\config;
use function DTApi\Repository\env;
use function DTApi\Repository\storage_path;
use function DTApi\Repository\trans;
...
class JobRepository extends BaseRepository
{
    ...
    function __construct(Job $model, MailerInterface $mailer, LoggerService $logger)
    {
...
//            $jobs['total'] = $totaljobs;
    ...
    public function store($user, $data)
    {
        ...
        $immediatetime = config('constants.immediate_time', 5);
